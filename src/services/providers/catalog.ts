...
export const PROVIDER_CATALOG: Record<ProviderKind, ProviderDefinition> = {
  openai: {
    ...
    name: 'OpenAI',
    shortName: 'OpenAI',
    color: colors.providers.openai,
    accent: colors.providers.openai,
  ...
  anthropic: {
    ...
    name: 'Anthropic',
    shortName: 'Claude',
    color: colors.providers.anthropic,
    accent: colors.providers.anthropic,
  ...
  openrouter: {
    ...
    color: colors.providers.openrouter,
    accent: colors.providers.openrouter,
  ...
  google: {
    ...
    shortName: 'Gemini',
    color: colors.providers.google,
    accent: colors.providers.google,
  ...
  custom: {
    ...
    name: 'Custom / Other',
    shortName: 'Custom',
    color: colors.providers.custom,
    accent: colors.providers.custom,
